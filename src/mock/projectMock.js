  ...
  projects: [
    {
      ...
      author: {
        name: 'CNN',
        avatar: '/images/avatars/avatar_1.svg'
      },
      price: '87',
      currency: '',
      type: '11',
      ...
      media: 'Facebook',
      likeCount : 88,
      LikeLogo: '/images/icons/like.png',
      LoveCount: 23,
      LoveLogo: '/images/icons/love.png',
      WowCount: 14,
      WowLogo: '/images/icons/wow.png',
      HahaCount: 19,
      HahaLogo: '/images/icons/haha.png',
      SadCount: 78,
      SadLogo: '/images/icons/sad.png',
      AngryCount: 93,
      AngryLogo: '/images/icons/angry.png',
    },
    {
      id: uuid(),
      title: '',
      author: {
        name: 'Asia Nine',
        avatar: '/images/avatars/avatar_2.svg'
      },
      price: '34',
      currency: '',
      type: '23',
    ...
    },
    {
      ...
      author: {
        name: 'News Asia',
        avatar: '/images/avatars/avatar_3.svg'
      },
      price: '334',
      currency: '',
      type: '98',
      ...
      start_date: moment(),
      end_date: moment(),
      updated_at: moment().subtract(12, 'hour')
    },
    {
      id: uuid(),
      title: '',
      author: {
        name: 'CNN',
        avatar: '/images/avatars/avatar_4.svg'
      },
      price: '66',
      currency: '',
      type: '16',
      ...
      start_date: moment(),
      end_date: moment(),
      updated_at: moment().subtract(2, 'hour')
    },
    {
      id: uuid(),
      title: '',
      author: {
        name: 'ABC',
        avatar: '/images/avatars/avatar_5.svg'
      },
      price: '565',
      currency: '',
      type: '23',
